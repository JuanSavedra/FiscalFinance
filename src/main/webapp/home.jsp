    ...
    <div class="flex min-h-screen">
        <div class="hidden lg:block relative w-1/2 bg-gray-800">
            <img class="absolute inset-0 h-full w-full object-cover"
                src="https://images.unsplash.com/photo-1604594849809-dfedbc827105?q=80&w=1974&auto=format&fit=crop"
            ...
            <div class="relative flex flex-col justify-center items-start h-full p-20">
                ...
                <p class="text-2xl text-white mt-4 max-w-md">Controle suas finanças e invista no seu futuro com
                    confiança e clareza.</p>
            </div>
        </div>
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
            <div class="w-full max-w-md">
                <div class="text-center lg:text-left mb-10">
                    <h2 class="text-3xl font-bold text-gray-800 dark:text-white">Acesse sua conta</h2>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Bem-vindo de volta! Por favor, insira seus
                        dados.</p>
                </div>
                <form action="login" method="post" id="login-form" class="space-y-6">
                    <div>
                        ...
                        <input id="Email" name="Email" type="email" autocomplete="email" placeholder="Digite seu e-mail"
                            required
                    ...
                    <c:if test="${empty account}">
                        <h6 class="text-red-800">${error}</h6>
                    </c:if>
                    <div>
                        <input type="submit" href="#" value="Login"
                ...
                <p class="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">Ainda não tem uma conta? <a
                        href="register.jsp" class="font-medium text-emerald-600 hover:text-emerald-500">Cadastre-se</a>
                </p>
            </div>
        </div>
    </div>
