...
<body>
    ...
    <main>
        ...
        <div class="container">
            <form method="post" action="deposits?action=edit">
                ...
                <div class="d-flex flex-column align-items-center mt-3 mb-3">
                    ...
                    <input id="Descrição" name="Descrição" class="w-100 fs-2 m-0 p-3 text-center rounded-3"
                           placeholder="Descrição da transação" type="text" value="${deposit.description}">
                </div>
                <div class="d-flex flex-column align-items-center mt-3 mb-3">
                    ...
                    <input id="Valor" name="Valor" class="w-100 fs-2 m-0 p-3 text-center rounded-3"
                           ...
                           type="number" required value="${deposit.value}">
                </div>
